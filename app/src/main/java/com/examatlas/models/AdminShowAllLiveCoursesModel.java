...
public class AdminShowAllLiveCoursesModel {
    ...
    public AdminShowAllLiveCoursesModel(String courseID, String title, String description, String teacherName, String tags, String categoryId, String subCategoryId, String subjectId, String startDate, String endDate, ArrayList<BookImageModels> imageArrayList, ArrayList studentArrayList, ArrayList liveClassArrayList) {
