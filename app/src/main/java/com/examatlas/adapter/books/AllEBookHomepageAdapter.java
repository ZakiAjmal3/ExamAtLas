...
public class AllEBookHomepageAdapter extends RecyclerView.Adapter<AllEBookHomepageAdapter.ViewHolder> {
    ...
    public AllEBookHomepageAdapter(Context context, ArrayList<AllBooksModel> allBooksModelArrayList, ArrayList<Boolean> heartToggleStates) {
    ...
    @NonNull
    @Override
    public AllEBookHomepageAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AllEBookHomepageAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllEBookHomepageAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
