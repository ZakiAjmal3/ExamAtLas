...
public class AdminLiveClassesViewerAdapter{
//public class AdminLiveClassesViewerAdapter extends RecyclerView.Adapter<AdminLiveClassesViewerAdapter.PeerViewHolder> {
//    private List<Participant> participantList = new ArrayList<>();
//    private final Meeting meeting;
//    public AdminLiveClassesViewerAdapter(Meeting meeting) {
...
//        return new PeerViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.live_classes_item_peer, parent, false));
//    }
//
//    @Override
