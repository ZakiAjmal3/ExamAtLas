...
import com.examatlas.activities.SingleBlogViewActivity;
...
public class BlogAdapter extends RecyclerView.Adapter<BlogAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull BlogAdapter.ViewHolder holder, int position) {
        ...
        // Get the title and limit it to 100 characters
        String titleText = blogModelArrayList.get(position).getTitle();
...
//                        }
//                    }
                    Intent intent = new Intent(context.getContext(), SingleBlogViewActivity.class);
